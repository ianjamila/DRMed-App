...
├── queue/consolidated/[visitId]/[groupId]/ ← consolidated (chemistry) page: a report card per finished result (report-cards.tsx) + the entry form for tests still on the bench
