...
- `docs/drmed-user-guide.html` — the staff + patient user guide (v2.18, 25 Sep 2026): every
...
- Every `raise exception` with a `P00NN` code needs a translation in `src/lib/accounting/pg-errors.ts` (in use on main: P0001–P0034, P0040–P0054; open branches hold more — claim with `npm run claim -- pcode <n>`, never pick by hand).
