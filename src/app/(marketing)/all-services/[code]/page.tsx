        ...
        <div className="rounded-xl border border-[color:var(--color-brand-bg-mid)] bg-white p-5">
          ...
          <dd className="mt-2 font-[family-name:var(--font-heading)] text-2xl font-extrabold text-[color:var(--color-brand-navy)]">
            {service.kind === "lab_package" ? (
              ...
              <span className="text-base font-semibold text-[color:var(--color-brand-text-soft)]">
          ...
          <section className="mt-10">
            ...
            <ul className="mt-4 grid gap-2 sm:grid-cols-2">
              {splitIncludes(service.description).map((item) => (
                <li
                  key={item}
                  className="flex items-start gap-2 rounded-lg border border-[color:var(--color-brand-bg-mid)] bg-white p-3 text-sm text-[color:var(--color-brand-text-mid)]"
                >
                  <span
                    aria-hidden
                    className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-[color:var(--color-brand-cyan)]"
                  />
                  <span>{item}</span>
                </li>
              ))}
