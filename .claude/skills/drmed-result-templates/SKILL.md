...
├── template-health.ts      ← 6 pure drift checks + daily/weekly email gate
├── collect-template-health.ts ← shared server scan for /api/cron/template-health and the admin health page
