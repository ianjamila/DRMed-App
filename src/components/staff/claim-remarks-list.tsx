...
// One test's history as a short list: claimed, unclaimed (with the reason),
// reassigned, and edits after it was finished ("Updated … by … — reason",
// 0176) — oldest first. Shared by the lab queue's Remarks column,
...
// The test pages' "History" block (claims and edits): the full list, no cap, with a heading
...
// and the accessible name; the test page's History has the full story.
